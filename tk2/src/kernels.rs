...
/// distribution + intrinsic IN ISOLATION (device-gated allclose vs an f32 reference) before any FA
/// work — the wide-core analog of `atb_probe`. `m`/`n` multiples of 32, `k` a multiple of 8.
