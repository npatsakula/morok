...
fn test_bufferize() {
    ...
    let r1 = UOp::range(UOp::const_(DType::Int32, crate::types::ConstValue::Int(10)), 0, AxisType::Loop);
    let r2 = UOp::range(UOp::const_(DType::Int32, crate::types::ConstValue::Int(20)), 1, AxisType::Loop);
...
fn test_bufferize_local() {
    let compute = UOp::const_(DType::Float32, crate::types::ConstValue::Float(1.0));
    let r = UOp::range(UOp::const_(DType::Int32, crate::types::ConstValue::Int(10)), 0, AxisType::Loop);
