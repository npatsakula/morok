...
> **Note:** This is a simplified presentation. The actual engine uses a 3-stage stack-based algorithm with path compression for efficiency.
...
The action space includes ~162 base actions (varies with available parallelism):
...
- `GROUPTOP(axis, amount)` — grouped reduction for tensor cores
