...
`SVOD_ORIGIN=1` के साथ हर नोड वह `OriginScope` भी कैरी करता है जिसके अंदर वह बना था, और
यह origin उसके content hash में शामिल होता है। तब अलग-अलग स्कोप में बने दो एक जैसे सबग्राफ़
*अलग* नोड होते हैं और तब तक शेयर नहीं होते जब तक कर्नेल कट origin हटा नहीं देता।
अपवाद हैं लिटरल, `BUFFER`/`PARAM`/`UNIQUE` के साथ: एक ही कॉन्स्टेंट दो स्कोप स्वतंत्र रूप से
बनाते हैं, इसलिए वहाँ origin सिर्फ़ उस नोड को बाँटता जिसे कट फिर से जोड़ देता है।
इस ट्रेड-ऑफ़ के लिए [कर्नेल की प्रोफ़ाइलिंग और बेंचमार्किंग](../tile-kernels/profiling.md) में
“कर्नेल को model code से जोड़ना” सेक्शन देखें।
:::
